...
-- insert into ninjas (first_name, last_name, age, dojo_id) values ('Francisco','Boisier',30, 9);
 ...
 -- update dojos set name = 'zzzz' where id = 12; 
-- select * from dojos;



-- SELECT * FROM dojos d left join ninjas n on d.id = n.dojo_id where d.id = 8
-- update ninjas set dojo_id = 9 where id = 1;
-- insert into ninjas (first_name, last_name, age, dojo_id) values ('Robby','Lawrence',20,2);
 select * from ninjas;
